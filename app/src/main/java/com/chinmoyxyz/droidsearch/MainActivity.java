...
public class MainActivity extends ActionBarActivity {
    ...
    private void showSuggestion(final ArrayList<InfoObject> apps_by_suggestion) {
        ...
        searchSuggestionListAdapter = new SearchSuggestionListAdapter(MainActivity.this, apps_by_suggestion);
        ...
        lv_app_search_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    Toast.makeText(MainActivity.this, "Sorry, \t" + infoObject.getAppname() + " has encountered some problem.", Toast.LENGTH_SHORT).show();
                }
